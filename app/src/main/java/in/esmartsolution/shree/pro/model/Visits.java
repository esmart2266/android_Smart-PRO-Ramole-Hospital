...
public class Visits implements Parcelable {
    ...
    public static final Creator<Visits> CREATOR = new Creator<Visits>() {
        @Override
        public Visits createFromParcel(Parcel source) {
            return new Visits(source);
        }
